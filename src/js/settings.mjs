...
export const API_POSTS_PROFILE = "social/profiles/<name>/posts"; //https://v2.api.noroff.dev/social/profiles/Fernanda/posts/?_author=true&_comments=true&_reactions=true

// export const API_GET_POSTS_PARAMS = "?_author=true&limit=10";
// export const API_GET_POSTS_PARAMS = "?_author=true&_comments=true&_reactions=true";
